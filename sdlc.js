...
const analysisOfRequirements = " Analysis of Requirements is the second step. developers are required to gather all the data needed to create the new system. This includes defining the system requirements for a prototype and the users.";
